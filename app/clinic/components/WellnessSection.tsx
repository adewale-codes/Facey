...
const blocks: Block[] = [
  ...
  {
    title: 'Why Choose Dr Rasha Clinic',
    paragraphs: [
      ...
      'In the dynamic world of aesthetic treatments, staying ahead is paramount. Dr Rasha Clinic prides itself on being at the forefront of innovation. We consistently adopt the latest techniques and cutting-edge technology to enhance our patients experience and deliver exceptional results. When you choose Dr Rasha Clinic, you choose a trusted partner on the journey to a more radiant and rejuvenated you from head to toe.'
    ],
